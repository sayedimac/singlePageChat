...
- It is the very basis of a chat bot style app and in the starting template, the chat agent simply calls the function app with a prompt and it respond with a greeting without any backend integration
